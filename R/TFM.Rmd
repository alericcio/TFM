...
Este estudio se refiere a un análisis, propuesto por el Hospital Clínico San Carlos de Madrid, sobre la posibilidad de encontrar patrones de edad, género, periodo temporal entre pacientes ingresados en la Urgencia del citado hospital. Para este trabajo se han utilizado los códigos: GRD, CDM y DCO que agrupan e identifican diferentes tipos de enfermedades, transporte, síntomas, intoxicaciones, efectos adversos de los medicamentos y cualquier otra razón por la que el paciente debe presentarse en la consulta.
</div>
