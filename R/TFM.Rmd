...
tablaedad <- as.data.frame(table(edad = factor(cut(diag_frecuentes$Edad, breaks = c(0, 6, 12, 19, 27, 60, 108), labels = c("primera infancia 0-5", "infancia 6-11", "adolescencia 12-18","juventud 19-26", "adultez 27-59", "vejez 60 y mas"), right = FALSE))))
